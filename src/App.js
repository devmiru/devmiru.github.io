  ...
  return (
    <div className="App">
     ...
     <div className="main-bg">
        ...
        <h5>Photograph by. Wonseok Choi | Shoot with iPhone<br />웹 페이지에 사용된 모든 사진은 직접 촬영한 사진을 사용했습니다.</h5>
     </div>

     <div className="blackbg-main">
       <h2>틀에 박히지 않은 생각으로.<br />틀에 박히지 않는 나로.</h2>
       <h3>
        과거에 의존하지 않고 언제나 새로운 것을 찾습니다.<br />
        트렌드하고 매일 매일이 새로움으로 설레는 개발자가 되고 싶습니다.<br /><br />
        학교에서 공부를 잘 하지도 않았고, 남들이 일찍 개발 공부를 시작할때,<br />
        저는 24살이라는 늦은 나이에 공부에 흥미를 느끼기 시작했습니다.<br /><br />
        이런 이유로 자괴감에 빠져 쓰러질 때, 저는 이 생각을 가지며 다시 달립니다.<br /><br />
        “Don't compare your beginning to someone else's middle”<br />
        "남들의 중간을 나의 출발점과 비교하지 말라."<br /><br />
